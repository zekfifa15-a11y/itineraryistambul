...
Use o pacote `istanbul-guide-github-pages-pwa-v3.zip`, preparado para publicação direta. Você não precisa instalar Node, usar terminal ou contratar Netlify. O visual, os três idiomas e as funções do roteiro são os mesmos; nesta edição, o checklist e as edições ficam salvos em cada aparelho.

A versão 3 ajusta o roteiro à grade confirmada da Zeynep, mantém os 14 dias e os 56 locais distribuídos entre os passeios principais e dois circuitos opcionais de segunda-feira, e acrescenta o passo a passo de chegada pelo aeroporto IST. Os circuitos entre aulas terminam na faculdade até 13h20; os passeios do dia terminam no Airbnb. Veja os detalhes em `REVISAO-AULAS-2026-09-10.md`. A configuração e as restrições de domínio do Google Maps continuam necessárias.
...
1. Baixe `istanbul-guide-github-pages-pwa-v3.zip` fornecido junto deste tutorial.
