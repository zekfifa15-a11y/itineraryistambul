...
Use o pacote `istanbul-guide-github-pages-pwa-v4.zip`, preparado para publicação direta. Você não precisa instalar Node, usar terminal ou contratar Netlify. O visual, os três idiomas e as funções do roteiro são os mesmos; nesta edição, o checklist e as edições ficam salvos em cada aparelho.

A versão 4 acrescenta Emek Börek e Lades Menemen, mantém os 14 dias e os 58 locais distribuídos no roteiro, e considera pelo menos 1h para Zeynep chegar ao Airbnb após as aulas, mais 15min para se preparar. O passo a passo de chegada pelo aeroporto IST continua no primeiro dia. Os circuitos entre aulas terminam na faculdade até 13h20; os passeios do dia terminam no Airbnb. Veja os detalhes em `REVISAO-2026-09-12.md`. A configuração e as restrições de domínio do Google Maps continuam necessárias.
...
1. Baixe `istanbul-guide-github-pages-pwa-v4.zip` fornecido junto deste tutorial.
